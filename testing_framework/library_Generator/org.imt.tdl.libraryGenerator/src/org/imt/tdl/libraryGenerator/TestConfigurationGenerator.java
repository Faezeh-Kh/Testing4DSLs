...
public class TestConfigurationGenerator {
	...
	public TestConfigurationGenerator(String dslName, String dslID, CommonPackageGenerator commonPackageGenerator,
			DSLSpecificEventsGenerator dslSpecificEventsGenerator) {
