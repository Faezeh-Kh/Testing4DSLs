 ...
 * @generated
 */
public class TDLTestReportSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case TDLTestReportPackage.TEST_SUITE_RESULT: {
				TestSuiteResult testSuiteResult = (TestSuiteResult)theEObject;
				T result = caseTestSuiteResult(testSuiteResult);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TDLTestReportPackage.TEST_CASE_RESULT: {
				TestCaseResult testCaseResult = (TestCaseResult)theEObject;
				T result = caseTestCaseResult(testCaseResult);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TDLTestReportPackage.TEST_MESSAGE_RESULT: {
				TestMessageResult testMessageResult = (TestMessageResult)theEObject;
				T result = caseTestMessageResult(testMessageResult);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Test Message Result</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Test Message Result</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseTestMessageResult(TestMessageResult object) {
		return null;
	}
